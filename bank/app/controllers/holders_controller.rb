class HoldersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @holder.save
        format.html { redirect_to @holder, notice: 'Titular criado com sucesso.' }
  ...
  def update
    respond_to do |format|
      if @holder.update(holder_params)
        format.html { redirect_to @holder, notice: 'Titular atualizado com sucesso.' }
  ...
  def destroy
    @holder.destroy
    respond_to do |format|
      format.html { redirect_to holders_url, notice: 'Titular excluido com sucesso.' }
  ...
  private
    ...
    def holder_params
      params.require(:holder).permit(:account_id, :name, :cpf)
    end
end
